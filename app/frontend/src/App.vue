                ...
                <div v-if="isMenuOpen" class="md:hidden bg-black/95 h-screen backdrop-blur-xl">
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <div class="flex px-3 py-4 items-center space-x-6">
                            <a :href="contactInfos && contactInfos?.length > 0 ? contactInfos[0].github : '#'" target="_blank"
                            ...
                            <a :href="contactInfos && contactInfos?.length > 0 ? contactInfos[0].linkedin : '#'" target="_blank"
                                @mouseenter="isHoveringInteractive = true" @mouseleave="isHoveringInteractive = false"
                                class="text-gray-400 hover:text-indigo-400 transition-colors">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor"
                                    viewBox="0 0 24 24">
            ...
            <section class="pt-20 md:pt-32 pb-16 md:pb-20 lg:pb-32">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="max-w-2xl">
                        ...
                        <p class="text-white/70 text-md sm:text-xl leading-relaxed mb-8 max-w-xl">
                ...
                <div v-if="!selectedProject">
                    ...
                    <div v-if="visibleCount < projects.length" class="flex justify-center mt-6">
                        <button @click="loadMore"
                                class="bg-white/5 w-max cursor-pointer mx-auto backdrop-blur-md text-white px-6 py-3 rounded-full hover:bg-white/20 transition-colors duration-200 text-sm font-medium flex items-center justify-center">
                            ...
                            <div class="rounded-2xl overflow-hidden mb-6 border border-gray-700/50">
                                <div
                                    ...
                                    <img v-else :src="selectedProject.image" alt="Project Image"
                                        class="w-full h-full object-fit object-center rounded-2xl">
                                </div>
                            </div>
                ...
                <div class="grid">
                    <div
                        ...
                        <form @submit.prevent="sendEmail" class="space-y-6">
                            ...
                            <button type="submit"
                                class="flex cursor-pointer group relative w-max mx-auto justify-center overflow-hidden rounded-full bg-white px-6 py-3 text-sm font-medium text-black transition-all duration-300 hover:shadow-xl hover:shadow-white/20">
